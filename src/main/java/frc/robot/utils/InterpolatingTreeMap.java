...
/**
 * Sourced from utility class to be added in 2023
 * 
 * https://github.com/Ashray-g/allwpilib/blob/added-interpolatingTreeMap/wpiutil/src/main/java/edu/wpi/first/util/InterpolatingTreeMap.java
 */
