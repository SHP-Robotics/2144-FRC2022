...
public class FlywheelSubsystem extends SubsystemBase {
    // private final WPI_TalonFX m_talon = new WPI_TalonFX(4);

    // private final SimpleMotorFeedforward m_flywheelFeedforward = new
    // SimpleMotorFeedforward(kS, kV, kA);
    // private final BangBangController m_bangBangController = new
    // BangBangController(kVelocityTolerance);
    ...
    // flywheelTalonConfig.supplyCurrLimit.currentLimit =
    // kFlywheelTalonCurrentLimit;
